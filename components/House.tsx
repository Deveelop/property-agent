...
const House = ({image, type, state, bathrooms, bedrooms, surface, price, address}: HouseDisplayProps) => {
  return (
    ...
    <div className='mb-4 flex gap-x-2 text-sm'>
      ...
      <div className='bg-orange-500 rounded-full text-white px-3'>{state}</div>
    </div>
